                  ...
                  trigger={
                    <div className="relative group cursor-pointer">
                      <img
                        ...
                        alt={p.name}
                        className="w-60 md:w-64 h-60 md:h-64 object-cover shadow border border-(--text) hover:brightness-75 transition"
                      />
                      <div className="absolute bottom-0 left-0 right-0 bg-linear-to-t from-black/80 to-transparent text-white leading-tight text-lg font-semibold pl-5 pr-16 pb-4 pt-16">
                        {p.name}
                      </div>
                    </div>
                  }
