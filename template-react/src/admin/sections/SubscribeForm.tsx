...
export default function SubscribeForm({ data, setData }: SubscribeFormProps) {
  ...
  const handleDragEnd = (event: any) => {
    ...
    const oldIndex = customSelect.options.findIndex(opt => opt.id === active.id)
    const newIndex = customSelect.options.findIndex(opt => opt.id === over.id)
          ...
          <div className="mt-2 space-y-4">
            <div>
              ...
              <Textarea
                ...
                placeholder="Cole aqui a URL completa do Microsoft Forms"
                onChange={e => {
            ...
            <div className="space-y-4">
              <div className="flex flex-col gap-2">
                ...
                <Input
                  ...
                  onChange={e => updateCustomSelect({ label: e.target.value })}
                />
              </div>
