export function Footer() {
	return (
		<div className="py-9 flex flex-col text-zinc-400 bg-zinc-900 justify-center gap-6 text-center text-sm border-t border-zinc-600">
			<div
				className=" w-32 mx-auto bg-zinc-400
     aspect-[217.9/52.3]
