/** biome-ignore lint/security/noDangerouslySetInnerHtml: HTML dos parágrafos vem do JSON de configuração */
/** biome-ignore-all lint/suspicious/noArrayIndexKey: <explanation> */
/** biome-ignore-all lint/security/noDangerouslySetInnerHtml: <explanation> */
/** biome-ignore lint/suspicious/noArrayIndexKey: Arrays estáticos do JSON */
import {
	FaFacebook,
	FaInstagram,
	FaLinkedin,
