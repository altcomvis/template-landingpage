...
export function ParticipantDrawer({
  ...
  return (
    <Drawer>
      ...
      <DrawerContent className="border-zinc-400">
        <div className="md:flex gap-4 md:w-4/12 mx-auto py-10">
          ...
          <DrawerHeader>
            <DrawerTitle className="md:text-left text-2xl text-[var(--text)]">
              {name}
            </DrawerTitle>
            <DrawerDescription className="md:text-left text-base text-[var(--text)]">
              {position}
            </DrawerDescription>
          </DrawerHeader>
        </div>
